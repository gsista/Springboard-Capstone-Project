...
#   origins <- x$origin_addresses[[1]]
#   destinations <- x$destination_addresses[[1]]
#  } else {
#  return(c(NA,NA,NA,NA,NA))
}
print(distance)
}
findapproxmatch("37.7929789,-122.4212424", "37.7225491,-122.4410618")
sapply(sf1, findapproxmatch(sf1$LatLong, sfmhp_latlong$LatLong))
```
...
# destinations = do.call(sfmhp_zips, )
# var <- findapproxmatch(origins, destinations)
